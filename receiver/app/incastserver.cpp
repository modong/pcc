...
//if(cchandle->hastimeout)
//cout<<cchandle->ends<<endl;
cout<<cchandle->start<<","<<cchandle->ends<<","<<count<<endl<<endl;
//cout<<"count"<<endl<<count<<endl;*/

cout<<cchandle->begintime.tv_usec<<'.'<<cchandle->endtime.tv_usec<<endl;
